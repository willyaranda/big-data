...
public class DHCPMapper extends
		Mapper<LongWritable, Text, DateWritable, Text> {
	...
	protected void map(LongWritable offset, Text line, Context context)
		...
		/*
		 * We want lines like this:
		 * Nov 26 08:05:47 ktalina dhclient: DHCPREQUEST of 192.168.1.129 on wlan0 to 255.255.255.255 port 67 (xid=0x4df17bbc)
		 * Regex 'em!
		 */
