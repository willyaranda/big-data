...
public class MaxMinMapper extends Mapper<LongWritable, Text, NullWritable, FloatWritable> {
	...
	protected void map(LongWritable offset, Text line, Context context) throws IOException ,InterruptedException {
		context.write(NullWritable.get(), new FloatWritable(Float.parseFloat(line.toString())));
	};
